				...
				<div id="menu-holder">
					...
					<div class="wrapper">
						...
						<ul id="nav" class="sf-menu">
							<li <?php if($page==1) echo "class=\"current-menu-item\""; ?>><a href="index.php">Accueil<span class="subheader">Moi-même</span></a></li>
							<li <?php if($page==2) echo "class=\"current-menu-item\""; ?>><a href="contact.php">Contact<span class="subheader">Par email</span></a></li>
						</ul>
						<!-- Navigation -->
					</div>
					<!-- wrapper-menu -->
